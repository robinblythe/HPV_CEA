...
age_cat <- c(
  "<10", "10-14", "15-19", "20-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54", "55-59",
...
hpv_oropharyngeal <- table(
  year = oropharyngeal_cancer$year_agg, age = oropharyngeal_cancer$age_agg,
  gender = oropharyngeal_cancer$gender
) |> as.data.frame()
...
hpv_oropharyngeal2 <- table(
  year = oropharyngeal_cancer2$year_agg, age = oropharyngeal_cancer2$age_agg,
  gender = oropharyngeal_cancer2$gender
) |> as.data.frame()
...
hpv_anal <- table(
  year = anal_cancer$year_agg, age = anal_cancer$age_agg,
  gender = anal_cancer$gender
) |> as.data.frame()
...
hpv_vaginal <- table(
  year = vaginal_cancer$year_agg, age = vaginal_cancer$age_agg,
  gender = vaginal_cancer$gender
) |> as.data.frame()
...
hpv_penile <- table(
  year = penile_cancer$year_agg, age = penile_cancer$age_agg,
  gender = penile_cancer$gender
) |> as.data.frame()
...
all_hpv_related_mort <- table(
  year = all_cancer_mort$year_agg, age = all_cancer_mort$age_agg,
  gender = all_cancer_mort$gender
) |> as.data.frame()
...
hpv_cervical_mort <- table(
  year = cervix_cancer_mort$year_agg, age = cervix_cancer_mort$age_agg,
  gender = cervix_cancer_mort$gender
) |> as.data.frame()
...
hpv_oropharyngeal_mort <- table(
  year = oropharyngeal_cancer_mort$year_agg, age = oropharyngeal_cancer_mort$age_agg,
  gender = oropharyngeal_cancer_mort$gender
) |> as.data.frame()
...
hpv_anal_mort <- table(
  year = anal_cancer_mort$year_agg, age = anal_cancer_mort$age_agg,
  gender = anal_cancer_mort$gender
) |> as.data.frame()
...
hpv_vaginal_mort <- table(
  year = vaginal_cancer_mort$year_agg, age = vaginal_cancer_mort$age_agg,
  gender = vaginal_cancer_mort$gender
) |> as.data.frame()
...
hpv_penile_mort <- table(
  year = penile_cancer_mort$year_agg, age = penile_cancer_mort$age_agg,
  gender = penile_cancer_mort$gender
) |> as.data.frame()
