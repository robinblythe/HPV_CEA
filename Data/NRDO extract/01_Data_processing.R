...
hpv_death_codes <- c(
  "C10", "146.3", "146.4", "146.5", "146.6", "146.7", "146.8", "146.9", # Oropharynx
  "C21", "154.2", "154.3", "154.8", # Anus and anal canal
  "C53", "180", # Cervix
  "C52", "184.0", # Vagina
  "C51", "184.1", "184.2", "184.3", "184.4", # Vulva
  "C60", "187.1", "187.2", "187.3", "187.4"
) # Penis
...
df_processed <- df_raw |>
  ...
  filter(
    year_of_diagnosis > 1992,
    !is.na(cancer_type)
  ) |>
  mutate(ID = row_number()) |>
  select(
    ID, cancer_type, gender, ethnic_group, year_of_diagnosis, age_at_diagnosis,
